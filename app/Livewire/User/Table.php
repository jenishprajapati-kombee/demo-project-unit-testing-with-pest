...
final class Table extends PowerGridComponent
{
    ...
    public function datasource(): Builder
    {
        ...
        return User::query()
            ...
            ->select([
                'users.id', 'users.name', 'users.email', 'roles.name as role_name', 'users.dob',
                DB::raw(
                    '(CASE
    ...
    public function filters(): array
    {
        return [
            ...
            Filter::inputText('name', 'users.name')
                ->operators(['contains'])
                ->placeholder(__('messages.user.filter.name_placeholder')),
            Filter::inputText('email', 'users.email')
                ->operators(['contains'])
                ->placeholder(__('messages.user.filter.email_placeholder')),
